  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        AvailableMarketsRequest.class.getName());
    }
    // Use AvailableMarketsRequest.newBuilder() to construct.
    private AvailableMarketsRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(eventUrn_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, eventUrn_);
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(eventUrn_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, eventUrn_);
      }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.oddin.obb.Markets.AvailableMarketsRequest result) {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        AvailableMarketsResponse.class.getName());
    }
    // Use AvailableMarketsResponse.newBuilder() to construct.
    private AvailableMarketsResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(com.oddin.obb.Markets.AvailableMarketsResponse result) {
        if (marketsBuilder_ == null) {
      ...
      private void buildPartial0(com.oddin.obb.Markets.AvailableMarketsResponse result) {
        int from_bitField0_ = bitField0_;
      }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        AvailableMarket.class.getName());
    }
    // Use AvailableMarket.newBuilder() to construct.
    private AvailableMarket(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.oddin.obb.Markets.AvailableMarket result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
