...
goog.exportSymbol('proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason', null, global);
goog.exportSymbol('proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.Code', null, global);
 ...
 * @constructor
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.displayName = 'proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.obb.SessionCreateResponse.SessionRejected.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    selectionsRejectedMap: (f = msg.getSelectionsRejectedMap()) ? f.toObject(includeInstance, proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.toObject) : []
  };
...
proto.obb.SessionCreateResponse.SessionRejected.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = msg.getSelectionsRejectedMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.deserializeBinaryFromReader, "", new proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason());
         });
      break;
    default:
      reader.skipField();
...
proto.obb.SessionCreateResponse.SessionRejected.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSelectionsRejectedMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.serializeBinaryToWriter);
  }
};
 ...
 * @return {!Object}
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.prototype.toObject = function(opt_includeInstance) {
  return proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.toObject = function(includeInstance, msg) {
  var f, obj = {
    code: jspb.Message.getFieldWithDefault(msg, 1, 0),
    message: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason}
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason;
  return proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason}
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.Code} */ (reader.readEnum());
      msg.setCode(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCode();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 * @enum {number}
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.Code = {
  CODE_UNSPECIFIED: 0,
...
/**
 * optional Code code = 1;
 * @return {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.Code}
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.prototype.getCode = function() {
  return /** @type {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.Code} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.Code} value
 * @return {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason} returns this
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.prototype.setCode = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason} returns this
 */
proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason.prototype.setMessage = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
/**
 * map<string, SelectionRejectedReason> selections_rejected = 2;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason>}
 */
proto.obb.SessionCreateResponse.SessionRejected.prototype.getSelectionsRejectedMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason>} */ (
      jspb.Message.getMapField(this, 2, opt_noLazyCreate,
      proto.obb.SessionCreateResponse.SessionRejected.SelectionRejectedReason));
};
 ...
 * @return {!proto.obb.SessionCreateResponse.SessionRejected} returns this
 */
proto.obb.SessionCreateResponse.SessionRejected.prototype.clearSelectionsRejectedMap = function() {
  this.getSelectionsRejectedMap().clear();
  return this;};
